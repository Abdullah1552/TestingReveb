    ...
    <script>
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    for(i in data.data){
                        ...
                        htmlData+='<td>'+data.data[i].CY_Name+'</td>';
                        htmlData+='<td>N/A</td>';
                        htmlData+='<td>';
        ...
        function edit(id) {
            ...
            $.ajax({
                ...
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                success:function (data) {
                    $("#city-form input[name~='id']").val(data.id);
                    $("#city-form input[name~='CY_Name']").val(data.CY_Name);
                    $("#city-form select[name~='ZID']").val(data.ZID);
                    $('.loader-bg').hide();
