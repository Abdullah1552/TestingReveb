...
<div class="col-md-12" style="position: relative;min-height: 100%;height: 100%; float: left;">
    ...
    <div style="width: 60%; float: left;">
        <table width="100%" style="font-family: sans-serif; margin-top: 0px;font-size: 12px;border:1px solid;float: left;" cellpadding="5">
            ...
            <tr>
                <td><div style="width:20%;float: left;text-align: right">User:</div><strong> &ensp; {{ isset($so->sale_created_by->name) && $so->sale_created_by->name ? $so->sale_created_by->name:"N/A"  }}</strong></td>
            </tr>
        </table>
    </div>
    <div style="width: 38%; float: left; margin-left: 10px">
        <table width="100%" style="font-family: sans-serif; margin-top: 0px;font-size: 12px;border:1px solid;" cellpadding="5">
            <tr>
                <td><div style="width:30%;float: left;text-align: right">Invoice No:</div><strong> &ensp;{{ $so->si }}</strong></td>
            </tr>
            <tr>
    ...
    <table style="width: 100%; font-family: sans-serif;text-align: center;border-collapse: collapse; margin-top: 10px;font-size: 12px;">
        ...
        <tr>
            <td colspan="6" align="right" style="padding: 3px;font-weight: bolder;"><b>Grand Total</b></td>
            <td style="border: 1px solid;font-weight: bolder;" class="text-red"><b>{{ $so->net_total }}</b></td>
        </tr>
        <tr>
            <td colspan="6" align="right" style="padding: 3px;font-weight: bolder;"><b>Receive amount</b> </td>
            <td style="border: 1px solid;" ><b>{{ $so->received_amount }}</b></td>
        </tr>
        <tr>
            <td colspan="6" align="right" style="padding: 3px;font-weight: bolder;"><b>Change</b></td>
            <td style="border: 1px solid;font-weight: bolder;"><b>{{ (float) $so->received_amount - (float)$so->net_total }}</b></td>
        </tr>
