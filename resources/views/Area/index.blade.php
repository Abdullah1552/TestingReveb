    ...
    <script>
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    $.each(vali, function( index, value ) {
                        $("#area-form input[name~='" + index + "']").css('border', '1px solid red');
                        toastr.error(value);
                    });
                    $('.loader-bg').hide();
                }
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    for(i in data){
                        ...
                        htmlData+='<td>'+data[i].AR_Name+'</td>';
                        htmlData+='<td>'+data[i].city.CY_Name+'</td>';
                        htmlData+='<td>';
        ...
        function edit(id) {
            ...
            $.ajax({
                ...
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                success:function (data) {
                    $("#area-form input[name~='id']").val(data.id);
                    $("#area-form input[name~='AR_Name']").val(data.AR_Name);
                    $("#area-form select[name~='CYID']").val(data.CYID);
                    $('.loader-bg').hide();
