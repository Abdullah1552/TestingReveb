            ...
            <div class="row no-report">
                <div class="main-header" style="margin-top: 0px;">
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item ative"> Trial Balance</li>
                    </ol>
                </div>
            </div>
            <!-- End start -->
                            ...
                            <table width="100%" style="font-family: sans-serif; display: none" class="report-show">
                                ...
                                <tr>
                                    <td colspan="8">
                                        ...
                                        <div class="headerDiv">
                                            <h4 style="margin-bottom: 0px;margin-top: 5px;font-size: 14px;">Trial Balance Report</h4>
                                        </div>
                                        <div class="headerDiv">
                            ...
                            <div class="col-sm-12 table-responsive pad0">
                                <table id="table2excel" class="table table-striped table-hover">
                                    ...
                                    @foreach($result as $item)
                                        <?php
                                        $balance=\App\Helpers\helpers::ob(date('Y-m-d'), $item->id);
                                        if($balance>0){
                                            $dr+=$balance;
                                        }else{
                                            $cr+=$balance;
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left">@if($balance>0) {{ \App\Helpers\helpers::show_bal_format($balance) }} @else 0.00 @endif</td>
                                            <td style="text-align: right">@if($balance<0) {{ \App\Helpers\helpers::show_bal_format($balance) }} @else 0.00 @endif</td>
                                        </tr>
                                    @endforeach
                                    <tr>
                                        <th>Total</th>
                                        <th style="border-bottom: double;border-top: double;text-align: right">{{ \App\Helpers\helpers::show_bal_format($dr) }}</th>
                                        <th style="border-bottom: double;border-top: double;text-align: right">{{ \App\Helpers\helpers::show_bal_format($cr) }}</th>
                                    </tr>
                                    </tbody>
                                </table>
