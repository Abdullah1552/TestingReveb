...
<div class="modal fade" id="purchase-return">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control date" name="date" autocomplete="off" required value="{{date('Y-m-d')}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="js-example-basic-single form-control  clients select2-hidden-accessible"  name="SUPID">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group" style="margin-top: 6px">
                                                ...
                                                <input type="number" id="order_discount_input" class="form-control" name="discount" value="0" style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Attachment</label><br>
                                                <input type="file" name="attachment" class="form-control-sm">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <table class="table table-bordered " >
                                            <tbody style="user-select: auto;"><tr style="background: darkgray; color: white">
                                                ...
                                                <td style="user-select: auto;"><strong style="user-select: auto;">Discount</strong>
