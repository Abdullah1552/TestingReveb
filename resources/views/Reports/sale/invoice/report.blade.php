<div class="col-md-12" style="min-height: 100%;height: 100%; float: left;">
    ...
    <table class="table-print table2excel"
        ...
        <tr style="margin-bottom: 100px;">
            ...
            <td style="font-family: sans-serif;    text-align: left;" colspan="4"><span style="font-size: 1.5rem;font-weight: bolder;">Sale Invoice Report</span>
        ...
        <tr style="border: 1px solid #000;" class="bg-dg">
            ...
            <th class="report_col">Sale person</th>
            <th class="report_col">Customer</th>
            <th class="report_col">Sale Type</th>
        ...
        @if(isset($reports) && count($reports))
            @foreach($reports as $report)
                    <tr style="border: 1px solid #000;">
                        ...
                        <td class="report_col">{{$report->sale_person_name}}</td>
                        <td class="report_col">{{$report->customer_name}}</td>
                        <td class="report_col" style="text-transform: uppercase;">{{$report->sale_type}}</td>
            ...
            @endforeach
            <tr style="border: 1px solid #000;" class="bg-dg">
                <th colspan="8"  class="report_col"> Total</th>
