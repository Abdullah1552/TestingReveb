<div class="col-md-12" style="min-height: 100%;height: 100%; float: left;">
    ...
    <table class="table-print table2excel"
        ...
        <tr style="margin-bottom: 100px;">
            ...
            <td  class="doc" style="font-family: sans-serif;    text-align: left;" colspan="2"><span
                    style="font-size: 1.5rem;font-weight: bolder;">Available Stock</span>
                <p class="line"><strong>Date:</strong> {{date("d-m-Y ", time())}}</p>
