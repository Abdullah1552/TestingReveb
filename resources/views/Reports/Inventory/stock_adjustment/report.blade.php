<div class="col-md-12" style="min-height: 100%;height: 100%; float: left;">
    ...
    <table class="table-print table2excel"
        ...
        <tr style="margin-bottom: 100px;">
            ...
            <td style="font-family: sans-serif;    text-align: right;" colspan="2"><span
                    style="font-size: 1.5rem;font-weight: bolder;">Stock Adjustment</span>
                <p class="line"><strong>Issue date:</strong> {{date("d-m-Y h:i:s a", time())}}</p>
                @if(isset($request->product_code) && $request->product_code) <p class="line"><strong>Product Code:</strong>{{$request->product_code}}</p> @endif
        ...
        <tr style="border: 1px solid #000;" class="bg-dg">
            ...
            <th style="border: 1px solid #000; padding: 3px;text-align:center">Action</th>
        ...
        @if(isset($products) && count($products))
            @foreach($products as $product)
                ...
                <tr style="border: 1px solid #000;">
                    ...
                    <td style="border: 1px solid #000; padding: 2px;text-align:center;">{{$product->warehouse_name}}</td>
                    <td style="border: 1px solid #000; padding: 2px;text-align:center;">{{$product->in_out=='1'?"Plus":"Minus"}}</td>
