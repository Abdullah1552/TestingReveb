...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="row no-report">
                <div class="main-header" style="margin-top: 0px;">
                    <h5>Consolidated Report-Purchase</h5>
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}"><i
                                    class="icofont icofont-home"></i></a></li>
                        <li class="breadcrumb-item">Reports</li>
                        <li class="breadcrumb-item">Purchase</li>
                        <li class="breadcrumb-item active">Consolidated Report-Purchase</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        @include('Reports.components.PurchaseFilters')
                        <div class="card-block">
                            <div class="col-sm-12 table-responsive" style="overflow: auto;">
                                <div id="report">
                                    @include('Reports.Purchase.consolidated-purchase.report')
                                </div>
                            </div>
                        </div>
                        <!--card-block-->
    ...
    <script>function get_reports() {
            ...
            $.ajax({
                url: "{{ url('/reports/purchase/consolidated-purchase') }}",
