<div class="col-md-12" style="min-height: 100%;height: 100%; float: left;">
    ...
    <table class="table-print table2excel"
        ...
        <tr style="margin-bottom: 100px;">
            ...
            <td style="font-family: sans-serif;    text-align: left;" colspan="2"><span style="font-size: 1.5rem;font-weight: bolder;">Product Wise Purchase  Report</span>
        ...
        @if(isset($reports) && count($reports))
            ...
            @endforeach
            <tr style="border: 1px solid #000;" class="bg-dg">
                <th colspan="10"  class="report_col"> Total</th>
