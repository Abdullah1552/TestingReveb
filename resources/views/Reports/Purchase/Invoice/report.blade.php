<div class="col-md-12" style="min-height: 100%;height: 100%; float: left;">
    ...
    <table class="table-print table2excel"
        ...
        <tr style="margin-bottom: 100px;">
            ...
            <td style="font-family: sans-serif;    text-align: left;" colspan="2"><span style="font-size: 1.5rem;font-weight: bolder;">Purchase Invoice Report</span>
        ...
        <tr style="border: 1px solid #000;" class="bg-dg">
            ...
            <th class="report_col">Supplier Reference</th>
        ...
        @if(isset($reports) && count($reports))
            @foreach($reports as $report)
                    <tr style="border: 1px solid #000;">
                        ...
                        <td class="report_col">{{date("d-m-Y", strtotime(substr($report->purchase_date,0,10))) }} </td>
                        <td class="report_col"><a  href="/print_purchase/{{$report->id}}" target="_blank">{{$report->id}}</a></td>
